...
return [
     ...
     */
    'open_platform' => [
        'app_id'   => env('COMPONENT_APP_ID','component-app-id'),
        'secret'   => env('COMPONENT_APP_SECRET','component-app-secret'),
        'token'    => env('COMPONENT_TOKEN','component-token'),
        'aes_key'  => env('COMPONENT_AES_KEY','component-aes-key'),
        /**
         * 事件推送URL
         */
